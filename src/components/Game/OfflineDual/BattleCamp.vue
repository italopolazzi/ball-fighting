...
<script>
import BattleResult from "@/components/Game/OfflineDual/BattleResult";
...
export default {
  ...
  computed: {
    ...mapGetters({ results: "game/offline_dual/battle/getBattleResults" })
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions({
      resetBattle: "game/offline_dual/battle/resetBattle",
      startBattle: "game/offline_dual/battle/startBattle"
    }),
    playAgain() {
      this.resetBattle();
      this.play();
